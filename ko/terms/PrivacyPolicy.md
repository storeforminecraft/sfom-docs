...
④ *'Store for Minecraft'*는 서비스 데이터베이스 운영을 위해 Google Asia Pacific Pte. Ltd.에게 수탁하는 과정에서 이용자의 개인정보를 국외로 이전하고 있습니다. 이에 대한 사항은 다음과 같습니다.
 ...
 - 수탁업체의 위치 : 싱가포르(70 Pasir Panjang Road, #03-71, Mapletree Business City II Singapore 117371)
 - 위탁 일시 및 방법 : 2020. 02. 23. ~ 현재 / 개인정보 수집과 동시에 이전되는 국가의 서버에 저장
 - 정보관리책임자 연락처 :  080-822-1422
 - 위탁업무 내용 : 서비스 데이터베이스 운영
...
①이 개인정보처리방침은 2021년 11월 28일부터 적용되며, 법령 및 방침에 따른 변경내용의 추가, 삭제 및 정정이 있는 경우에는 변경사항의 시행 7일 전부터 공지사항을 통하여 고지할 것입니다.
